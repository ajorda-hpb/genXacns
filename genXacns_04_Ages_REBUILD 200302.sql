...
Missing Index Details from genXacns_Age CREATE live 191106.sql - sage.master (HPB\ajorda (51))
The Query Processor estimates that implementing the following index could improve the query cost by 36.3149%.

USE [ReportsView]
GO
CREATE NONCLUSTERED INDEX [ncidx_genXacns_flow_QtyItemU]
ON [dbo].[genXacns] ([flow])
INCLUDE ([Qty],[Item],[u])
GO

select *
from ReportsView..genXacns ng
...
truncate table ReportsView.dbo.genXacns_Ages
